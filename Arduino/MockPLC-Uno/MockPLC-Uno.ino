...
#ifndef DEBUG
  mb.config(&altSerial, 38400); //SERIAL_8N1
...
// RAM Control
  ...
  if (!WARMUP) {
    ...
    if ((ENCITER == 5) && millis() - PREVTIMEOPS > MONTIME) {
      ...
      Serial.print(enc1, HEX); Serial.print(" "); Serial.print(enc2, HEX); Serial.print(" "); Serial.print(enc3, HEX); Serial.print(" "); 
      Serial.print(0, HEX); Serial.print(" "); Serial.print(0, HEX); Serial.print(" "); 
